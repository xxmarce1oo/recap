...
interface Profile {
    ...
    username: string;
    avatar_url: string;
    banner_movie_id: number;
    banner_backdrop_path: string;
    banner_position: string;
    fav_movie_id_1: number;
    fav_movie_id_2: number;
    fav_movie_id_3: number;
    fav_movie_id_4: number;
}
                        ...
                        <div className="flex flex-col items-center text-center">
                            ...
                            <div className="mt-4 pointer-events-auto">
                                ...
                                <div className="flex justify-center gap-4 text-sm mt-2">
                                    ...
                                    <span><strong className="text-white">{friendshipCounts.following}</strong> <span className="text-gray-400">seguindo</span></span>
                                </div>
                            </div>
                                ...
                                <div className="grid grid-cols-4 gap-4">
                                    {favoriteMovies.map((movie, index) => (
                                        <FavoriteMovieSlot 
                                            key={index} 
                                            movie={movie} 
                                            onSelectSlot={() => { if(isOwnProfile) { setIsFavoriteSearchModalOpen(true); setEditingSlot(index); } }} 
                                        />
                                    ))}
                                </div>
                            </div>
